...
CausalPlayground facilitates the creation, manipulation, and sampling of SCM as described below. The complete documentation can 
be found at TODO
...
```
>>> from CausalPlayground.scm_environment import SCMEnvironment
...
``` 
>>> from CausalPlayground.functions import f_linear
